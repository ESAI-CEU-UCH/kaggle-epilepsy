...
local cor_base = table.remove(arg,1)
...
assert(not cor_base:match("^%-%-"),
       "Needs a cor base list (without subject, with .train) as third argument")
